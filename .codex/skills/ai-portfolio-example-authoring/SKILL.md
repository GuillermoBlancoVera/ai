...
- Make examples readable in a technical portfolio walkthrough.
...
5. Update `docs/index.html` when the example changes the public index, featured work, or portfolio positioning.
6. Update the notebook README in the matching `notebooks/<category>/` folder if the example should later have a notebook version.
7. If the repo structure changed, run:
...
- Keep code straightforward and portfolio-friendly.
